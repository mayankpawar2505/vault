                  ...
                  <div class="x_content">
                    ...
                    <form id="data-form" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <textarea name="body" class="form-control col-md-7 col-xs-12" id="body"></textarea>
                        </div>
                      </div>
    ...
    <script type="text/javascript">
      ...
      $('#data-form').on('submit', function(e){
          ...
          if(title.length > 0 && body.length > 0){
            ...
            $.post('action/data/add_data.php',{title: enc_title, body:enc_body, category_id:category_id, k:password_key, token:$('#csrf-token').val()},function(resp){
              if(resp > 0){
                alert('Data Added Successfully');
                window.location.href='list-data.php?data=<?php echo $_GET['data']; ?>';
              }
            });
