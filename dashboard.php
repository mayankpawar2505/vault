                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <p class="text-muted font-13 m-b-30">
                      Categories
                      <span class="pull-right"> <a class="btn btn-sm btn-default" href="add-category.php"><span class="fa fa-plus"></span> Add  Category</a></span>
                      <?php  
                    ...
                    <?php
                      ...
                      $category_records = get_multiple_row_data($data);
                    ?>
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        <?php
                          if( !empty($category_records) && count($category_records) > 0){
